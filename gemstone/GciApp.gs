...
%
set compile_env: 0
! ------------------- Class definition for GciTsLibrary
expectvalue /Class
doit
...
WebApp subclass: 'GciLibraryApp'
  instVarNames: #(error requestDict result session socketFileHandle)
  classVars: #()
  classInstVars: #()
  poolDictionaries: #()
  inDictionary: GciApp
...
input GciClampedTravArgsSType.gs
input GciDateTimeSType.gs
input GciFetchObjInfoArgsSType.gs
input GciLibraryApp.gs
input GciObjInfoSType.gs
input GciObjRepHdrSType.gs
input GciObjRepSType.gs
input GciStoreTravDoArgsSType.gs
input GciStoreTravDoArgsSType_continueArgs.gs
input GciStoreTravDoArgsSType_executestr.gs
input GciStoreTravDoArgsSType_perform.gs
input GciTravBufType.gs
input GciTsLibraryFull.gs
